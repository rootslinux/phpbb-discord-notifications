...
$lang = array_merge($lang, array(
	...
	'DN_POST_PREVIEW_DESCRIPTION'	=> 'Specify the number of characters to display in a post preview (2048 or less). A zero value disables post preview.',
	'DN_TEST_MESSAGE'				=> 'Send a short message to Discord for testing',
	'DN_TEXT_MESSAGE_DEFAULT'		=> 'This is a test:  Hello Discord!',
	'DN_TEST_DESCRIPTION'			=> 'Click the \'test\' button to verify that your Discord webhook is setup correctly.',
	...
	'DN_MASTER_WEBHOOK_REQUIRED'	=> 'A valid webhook URL is required to enable notifications',
	'DN_WEBHOOK_URL_INVALID'		=> 'Webhook URL must be a full an valid URL',
	'DN_POST_PREVIEW_INVALID'		=> 'Post preview length must be a positive number',
	'DN_POST_PREVIEW_BAD_VALUE'		=> 'Post preview length must be between 0 and 2048',
));
