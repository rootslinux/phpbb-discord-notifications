...
class extension_installation extends \phpbb\db\migration\migration
{
	...
	{
		return isset($this->config['discord_notifications']);
	}
		...
		return array(
			'add_columns'	=> array(
				$this->table_prefix . 'forums'	=> array(
					'discord_notifications_enabled'	=> array('BOOL', 0),
				),
			),
		);
	}
	...
	*/
	...
	{
		return array(
			// The "master switch" that enables notifications to be sent. This can only be set to true if the discord_webhook_url is valid
			...
			// By default upon installation, every notification type begins as being enabled
			...
			// The webhook generated by Discord to send the notifications to. If this is an empty string, enable_discord_notifications sho
			array('config_text.add', array('discord_webhook_url', '')),



			// Stanard ACP module data
